...
(function (root, factory) {
  ...
  return function () {
    ...
    sankey.tweakNodeBreadths.moveSourcesRight = function moveSourcesRight(
      nodes,
      x
    ) {
    ...
    sankey.tweakNodeBreadths.moveSinksRight = function moveSinksRight(
      nodes,
      x
    ) {
      nodes.forEach(function (node) {
    ...
    sankey.sinksRight = function (sr) {
      return sankey.tweakNodeBreadths(
        sr ? sankey.tweakNodeBreadths.moveSinksRight : null
      );
    };
